...
type Identity struct {
	...
	Id          	string 			`json:"id"`          //Primary key for type Identity
	Owner       	OwnerRelation 	`json:"owner"`
	IDAttribute   []IDAttribute     `json:"IDAttribute"`
}
...
type Owner struct {
	ObjectType string `json:"docType"` 						//field for couchdb
	Id         string `json:"id"`							//Primary key for type Owner
...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	fmt.Println("Identity Management System Is Starting Up")
...
// ===========================================================================
// Invoke - entry point for the invocation
// ===========================================================================
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if function == "init" { //initialize the chaincode state and also used as reset
		return t.Init(stub)
	...
	} else if function == "read_everything" { //read everything, (owners  + identity + companies)
...
// =======================================================================
// Read - Reading a generic variable from ledger
//
...
func read(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	key = args[0]
	valAsbytes, err := stub.GetState(key) //Getting the value from ledger
	if err != nil {
...
// ============================================================================================================================
// write() - Writing generic variable to the ledger
//
...
// ============================================================================================================================
// Init identity - Creates a new identity and stores in the chaincode state
//
...
func  init_identity(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("Starting init identity function")
...
// ============================================================================================================================
// Sign Attribute By Identity - Sign 1 specific attribute of 1 identity (based on Identity.id). 
// args[0] = identity.id
// args[1] = identity.IDAttribute.IDKey
// args[2] = issuer name
...
func sign_attribute (stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// Getting the relevant [i] using idKey matching
	iFound := -999
	fmt.Println("Reading identity attribute on " + identity.Id)
	for i := range identity.IDAttribute {
		if identity.IDAttribute[i].IDKey == idKey {
